...
RoxyUtils.GetCookies = function () {
    var a = new Object(); var b = document.cookie.replace(" ", ""); b = b.split(";"); for (i in b) {
        var c = b[i].split("=");
        if (c.length > 1) {
            try{
